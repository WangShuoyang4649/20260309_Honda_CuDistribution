...
class ContourCut:
    ...
    def ask_inputs(self):
        ...
        if not a_data_input.ask():
            ...
            self.xslit_num = a_setting.add_integer('Slit number (X)', 10)
            self.xslit_csvfile_path = a_setting.add_file('Slit positions (X, csv)')
            self.xslit_width = a_setting.add_integer('Slit width (X)', 25)
            self.yslit_num = a_setting.add_integer('Slit number (Y)', 10)
            self.yslit_csvfile_path = a_setting.add_file('Slit positions (Y, csv)')
            self.yslit_width = a_setting.add_integer('Slit width (Y)', 25)
